...
export default function MembersPage({ searchQuery, members }) {
  ...
  if (members.membersLoading) {
    return <div className="sidebar-loading"><span className="mini-spinner"></span></div>;
  }
    ...
    <section className="members-page">
      ...
      {filteredMembers.length === 0 ? (
        <div className="status-empty">
          ...
          <span>{searchQuery.trim() ? 'Try another keyword.' : 'Have someone register to appear here.'}</span>
        </div>
      ) : (
